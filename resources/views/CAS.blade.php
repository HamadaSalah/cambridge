            ...
            <div class="">
                <div class="px-3 py-4 light_gray_bg rounded-3 mt-5">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{asset($cas->sec1_img)}}" alt="" style="max-height: 400px;
                            text-align: right;
    ...
    <div class="container mb-5">
        <div class="row flex-column-reverse flex-md-column-reverse flex-lg-row-reverse flex-xl-row-reverse flex-xxl-row-reverse mt-5">
            ...
            <div class="col-12 mt-4">
                ...
                <div class="col-12 mt-4">
                    <img src="{{asset($cas->sec5_img)}}" alt="" class="h-50 w-100 rounded-3" style="width: 50%!important;display: block!important;margin: auto!important">
                </div>
            </div>
        </div>
    </div>
