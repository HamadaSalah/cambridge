...
<form method="POST" action="{{route('admin.cas.update', $cas->id)}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <img src="{{asset($cas->sec3_img)}}" alt="" style="width: 100px;height: 100px;display: block;margin-bottom: 20px;border-radius: 5px">
        <input type="file" class="form-control" id="img" name="sec3_img"  placeholder="Write Body.." value="{{$cas->sec1_img}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <img src="{{asset($cas->sec5_img)}}" alt="" style="width: 100px;height: 100px;display: block;margin-bottom: 20px;border-radius: 5px">
