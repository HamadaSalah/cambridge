...
class IBDPController extends Controller
{
    use StoreImageTrait;
    /**
    ...
    {
        $ibdp = IBDP::first();
        return view('Admin.IBDP.edit', compact('ibdp'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // $requestData['sec6_img'] = $this->verifyAndStoreImage($request, 'sec6_img');
        // dd($requestData);
        $wel = IBDP::findOrFail(1);
        $wel->update([
